...
public class WarpedGrapeFeature extends Feature<BlockStateConfiguration> {

    public WarpedGrapeFeature(Codec<BlockStateConfiguration> codec) {
        super(codec);
    }
    ...
    public boolean place(FeaturePlaceContext<BlockStateConfiguration> context) {
        ...
        for (int i = 0; i < tries; i++) {
            ...
            // Check if the block at the chosen location is a Warped Wart Block
            if (context.level().getBlockState(mutable).is(Blocks.WARPED_WART_BLOCK)) {
